...
def test_total_estimator_without_str():
    ...
    assert np.isclose(svy_total_without_str.point_est["__none__"], 7938.333)
    assert np.isclose(svy_total_without_str.variance["__none__"], 560.0856 ** 2)
    assert np.isclose(svy_total_without_str.stderror["__none__"], 560.0856)
    assert np.isclose(svy_total_without_str.lower_ci["__none__"], 6813.915)
    assert np.isclose(svy_total_without_str.upper_ci["__none__"], 9062.752)
    assert np.isclose(svy_total_without_str.coef_var["__none__"], 560.0856 / 7938.333)
...
def test_total_estimator_without_str_nor_psu():
    ...
    assert np.isclose(svy_total_without_str.point_est["__none__"], 7938.333)
    assert np.isclose(svy_total_without_str.variance["__none__"], 105.3852 ** 2)
    assert np.isclose(svy_total_without_str.stderror["__none__"], 105.3852)
    assert np.isclose(svy_total_without_str.lower_ci["__none__"], 7731.754)
    assert np.isclose(svy_total_without_str.upper_ci["__none__"], 8144.913)
    assert np.isclose(svy_total_without_str.coef_var["__none__"], 105.3852 / 7938.333)
...
def test_total_estimator_with_str():
    ...
    assert np.isclose(svy_total_with_str.point_est["__none__"], 7938.333)
    assert np.isclose(svy_total_with_str.variance["__none__"], 555.5157 ** 2)
    assert np.isclose(svy_total_with_str.stderror["__none__"], 555.5157)
    assert np.isclose(svy_total_with_str.lower_ci["__none__"], 6814.697)
    assert np.isclose(svy_total_with_str.upper_ci["__none__"], 9061.970)
    assert np.isclose(svy_total_with_str.coef_var["__none__"], 555.5157 / 7938.333)
...
def test_total_estimator_with_str_without_psu():
    ...
    assert np.isclose(svy_total_with_str.point_est["__none__"], 7938.333)
    assert np.isclose(svy_total_with_str.variance["__none__"], 97.75523 ** 2)
    assert np.isclose(svy_total_with_str.stderror["__none__"], 97.75523)
    assert np.isclose(svy_total_with_str.lower_ci["__none__"], 7746.71)
    assert np.isclose(svy_total_with_str.upper_ci["__none__"], 8129.957)
    assert np.isclose(svy_total_with_str.coef_var["__none__"], 97.75523 / 7938.333)
...
def test_mean_estimator_without_str():
    ...
    assert np.isclose(svy_mean_without_str.point_est["__none__"], 0.813_622_5)
    assert np.isclose(svy_mean_without_str.variance["__none__"], 0.020_285_6 ** 2)
    assert np.isclose(svy_mean_without_str.stderror["__none__"], 0.020_285_6)
    assert np.isclose(svy_mean_without_str.lower_ci["__none__"], 0.772_897_5)
    assert np.isclose(svy_mean_without_str.upper_ci["__none__"], 0.854_347_5)
    assert np.isclose(svy_mean_without_str.coef_var["__none__"], 0.020_285_6 / 0.813_622_5)


def test_mean_estimator_without_str_nor_psu():
    svy_mean_without_str.estimate(y, weight, remove_nan=True)

    assert np.isclose(svy_mean_without_str.point_est["__none__"], 0.8136225)
    assert np.isclose(svy_mean_without_str.variance["__none__"], 0.0066567 ** 2)
    assert np.isclose(svy_mean_without_str.stderror["__none__"], 0.0066567)
    assert np.isclose(svy_mean_without_str.lower_ci["__none__"], 0.8005738)
    assert np.isclose(svy_mean_without_str.upper_ci["__none__"], 0.8266712)
    assert np.isclose(svy_mean_without_str.coef_var["__none__"], 0.0066567 / 0.8136225)
...
def test_mean_estimator_with_str():
    ...
    assert np.isclose(svy_mean_with_str.point_est["__none__"], 0.813_622_5)
    assert np.isclose(svy_mean_with_str.variance["__none__"], 0.019_862_1 ** 2)
    assert np.isclose(svy_mean_with_str.stderror["__none__"], 0.019_862_1)
    assert np.isclose(svy_mean_with_str.lower_ci["__none__"], 0.773_447_6)
    assert np.isclose(svy_mean_with_str.upper_ci["__none__"], 0.853_797_4)
    assert np.isclose(svy_mean_with_str.coef_var["__none__"], 0.019_862_1 / 0.813_622_5)


def test_mean_estimator_with_str_without_psu():
    svy_mean_with_str.estimate(y, weight, stratum=stratum, remove_nan=True)

    assert np.isclose(svy_mean_with_str.point_est["__none__"], 0.8136225)
    assert np.isclose(svy_mean_with_str.variance["__none__"], 0.0066091 ** 2)
    assert np.isclose(svy_mean_with_str.stderror["__none__"], 0.0066091)
    assert np.isclose(svy_mean_with_str.lower_ci["__none__"], 0.8006671)
    assert np.isclose(svy_mean_with_str.upper_ci["__none__"], 0.8265779)
    assert np.isclose(svy_mean_with_str.coef_var["__none__"], 0.0066091 / 0.8136225)
...
def test_ratio_estimator_without_str():
    ...
    assert np.isclose(svy_ratio_without_str.point_est["__none__"], 0.706_945_8)
    assert np.isclose(svy_ratio_without_str.variance["__none__"], 0.007_657_5 ** 2)
    assert np.isclose(svy_ratio_without_str.stderror["__none__"], 0.007_657_5)
    assert np.isclose(svy_ratio_without_str.lower_ci["__none__"], 0.691_572_8)
    assert np.isclose(svy_ratio_without_str.upper_ci["__none__"], 0.722_318_8)
    assert np.isclose(svy_ratio_without_str.coef_var["__none__"], 0.007_657_5 / 0.706_945_8)


def test_ratio_estimator_without_str_nor_psu():
    svy_ratio_without_str.estimate(y, weight, x, remove_nan=True)

    assert np.isclose(svy_ratio_without_str.point_est["__none__"], 0.7069458)
    assert np.isclose(svy_ratio_without_str.variance["__none__"], 0.0025128 ** 2)
    assert np.isclose(svy_ratio_without_str.stderror["__none__"], 0.0025128)
    assert np.isclose(svy_ratio_without_str.lower_ci["__none__"], 0.7020202)
    assert np.isclose(svy_ratio_without_str.upper_ci["__none__"], 0.7118715)
    assert np.isclose(svy_ratio_without_str.coef_var["__none__"], 0.0025128 / 0.7069458)
...
def test_ratio_estimator_with_str():
    ...
    assert np.isclose(svy_ratio_with_str.point_est["__none__"], 0.706_945_8)
    assert np.isclose(svy_ratio_with_str.variance["__none__"], 0.007_497_6 ** 2)
    assert np.isclose(svy_ratio_with_str.stderror["__none__"], 0.007_497_6)
    assert np.isclose(svy_ratio_with_str.lower_ci["__none__"], 0.691_780_5)
    assert np.isclose(svy_ratio_with_str.upper_ci["__none__"], 0.722_111_1)
    assert np.isclose(svy_ratio_with_str.coef_var["__none__"], 0.007_497_6 / 0.706_945_8)


def test_ratio_estimator_with_str_without_psu():
    svy_ratio_with_str.estimate(y, weight, x, stratum=stratum, remove_nan=True)

    assert np.isclose(svy_ratio_with_str.point_est["__none__"], 0.7069458)
    assert np.isclose(svy_ratio_with_str.variance["__none__"], 0.0024948 ** 2)
    assert np.isclose(svy_ratio_with_str.stderror["__none__"], 0.0024948)
    assert np.isclose(svy_ratio_with_str.lower_ci["__none__"], 0.7020554)
    assert np.isclose(svy_ratio_with_str.upper_ci["__none__"], 0.7118362)
    assert np.isclose(svy_ratio_with_str.coef_var["__none__"], 0.0024948 / 0.7069458)
