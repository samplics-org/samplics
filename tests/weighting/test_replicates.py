...
no_str_boot = ReplicateWeight(method=RepMethod.bootstrap, strat=False, nb_reps=nb_reps)
...
str_boot = ReplicateWeight(method=RepMethod.bootstrap, strat=True, nb_reps=nb_reps)
...
no_str_jk = ReplicateWeight(method=RepMethod.jackknife, strat=False)
...
str_jk = ReplicateWeight(method=RepMethod.jackknife, strat=True)
