...
no_str_brr = ReplicateWeight(method="brr", strat=False, nb_reps=nb_reps, fay_coef=0.05)
...
str_brr = ReplicateWeight(method="brr", strat=True, nb_reps=nb_reps, fay_coef=0.05)
...
no_str_boot = ReplicateWeight(method="bootstrap", strat=False, nb_reps=nb_reps)
...
str_boot = ReplicateWeight(method="bootstrap", strat=True, nb_reps=nb_reps)
...
no_str_jk = ReplicateWeight(method="jackknife", strat=False)
...
str_jk = ReplicateWeight(method="jackknife", strat=True)
