...
from samplics.sampling import SampleSizeMeanOneSample, SampleSizePropOneSample, calculate_power
...
def test_ss_diff_prop_one_side1():
    size_diff_prop_one_side.calculate(prop_0=0.3, prop_1=0.5, delta=-0.10, alpha=0.05, power=0.80)
...
def test_ss_diff_prop_two_sides2():
    size_diff_prop_two_sides.calculate(prop_0=0.6, prop_1=0.6, delta=-0.20, alpha=0.05, power=0.80)
