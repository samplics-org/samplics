...
#     size_diff_mean_one_side.calculate(delta=0.8, sigma=3, alpha=0.05, power=0.80)
...
#     size_diff_mean_one_side.calculate(delta=0.6, sigma=3, alpha=0.05, power=0.80)
...
#     size_diff_mean_one_side.calculate(delta=0.2, sigma=3, alpha=0.05, power=0.80)
...
#     size_diff_mean_two_sides.calculate(delta=0.8, sigma=3, alpha=0.05, power=0.80)
...
#     size_diff_mean_two_sides.calculate(delta=0.6, sigma=3, alpha=0.05, power=0.80)
#     assert size_diff_mean_two_sides.samp_size == 197
#     assert np.isclose(size_diff_mean_two_sides.actual_power, 0.802, atol=0.001)


# def test_ss_diff_mean_two_sides4():
#     size_diff_mean_two_sides.calculate(delta=0.2, sigma=3, alpha=0.05, power=0.80)
