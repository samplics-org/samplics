...
def test_power_for_one_prop_two_sides_number_not_arcsin():
    power1 = power_for_one_proportion(
        samp_size=107, prop_0=0.2, prop_1=0.1, arcsin=False, testing_type="two-side", alpha=0.05
    )
    power2 = power_for_one_proportion(
        samp_size=25, prop_0=0.3, prop_1=0.7, arcsin=False, testing_type="two-side", alpha=0.10
    )
    power3 = power_for_one_proportion(
        samp_size=500, prop_0=0.95, prop_1=0.99, arcsin=False, testing_type="two-side", alpha=0.07
    )
    power4 = power_for_one_proportion(
        samp_size=50,
        prop_0=0.0950,
...
def test_power_for_one_prop_two_sides_array_not_arcsin():
    samp_size = np.array([107, 25, 500, 50])
    prop_0 = (0.2, 0.3, 0.95, 0.0950)
    prop_1 = [0.1, 0.7, 0.99, 0.1990]
    alpha = [0.05, 0.10, 0.07, 0.01]
...
def test_power_for_one_prop_two_sides_dict_not_arcsin():
    samp_size = {"one": 107, "two": 25, "three": 500, "four": 50}
    prop_0 = {"one": 0.2, "two": 0.3, "three": 0.95, "four": 0.095}
    prop_1 = {"one": 0.1, "two": 0.7, "three": 0.99, "four": 0.199}
    alpha = {"one": 0.05, "two": 0.10, "three": 0.07, "four": 0.01}
...
def test_power_for_one_prop_one_less_number_not_arcsin():
